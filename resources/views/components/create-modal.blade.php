    <!-- Modal -->
    <div id="modal" class="modal modal-create fixed w-full h-full top-0 left-0 flex items-center justify-center">
                    ...
                    <form id="createContact">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-2 px-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="nom" name="nom" autocomplete="nom" required
                                    class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div class="mb-2 px-6">
                            ...
                            <input type="text" id="entreprise" name="entreprise" autocomplete="entreprise" required
                                class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <!-- Third Row -->
                        <div class="mb-2 px-6">
                        ...
                        <div class="grid grid-cols-3 gap-4 mb-2 px-6">
                            ...
                            <div class="col-span-3 md:col-span-1">
                                <label for="zipcode" class="block text-sm font-medium text-gray-700">Code
                                    Postal</label>
                                <input type="number" id="zipcode" name="code_postal" autocomplete="zipcode" required
                                    class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            <!-- City -->
                            <div class="col-span-3 md:col-span-2">
                                <label for="city" class="block text-sm font-medium text-gray-700">Ville</label>
                                <input type="text" id="city" name="ville" autocomplete="city" required
                                    class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                        </div>
                        <!-- First Row -->
                        ...
                        <div class="flex justify-end px-6 py-6" style="background: #eff5f5;">
                            <button type="button"
                                class="modal-close px-4 bg-indigo-500 p-3 rounded-lg text-white hover:bg-indigo-400 cancel mr-4">Annuler</button>
                            <button type="submit"
                                class="px-4 bg-indigo-500 p-3 rounded-lg text-white hover:bg-indigo-400 add">Valider</button>
                        </div>
                    </form>
                </div>
            </div>
